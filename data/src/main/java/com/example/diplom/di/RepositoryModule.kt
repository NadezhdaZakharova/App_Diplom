...
import com.example.diplom.data.importing.TrainerWorkoutImportPreprocessorImpl
...
interface RepositoryModule {
    ...
    @Binds
    @Singleton
    fun bindTrainerWorkoutImportPreprocessor(
        impl: TrainerWorkoutImportPreprocessorImpl
    ): TrainerWorkoutImportPreprocessor
}
