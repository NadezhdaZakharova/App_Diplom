...
object UiStrings {
    ...
    const val ROLE_TRAINER = "Тренер"

    const val MODE_TITLE_STUDENT = "Режим ученика"
    const val MODE_TITLE_TRAINER = "Режим тренера"
    ...
    const val TRAINER_PLAN_HEADING = "Тренировка для ученика"
    ...
    const val ADD_OWN_EXERCISE = "Добавить своё упражнение"
